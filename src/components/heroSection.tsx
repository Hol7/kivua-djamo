    ...
    <div className=" w-full h-full flex mt-24 ">
      <div className="w-full flex flex-col justify-center gap-8 pl-40">
        ...
        <div className="flex items-center gap-3">
          <input
            value="+225"
            className="border-2  rounded-lg text-lg p-1 w-16"
          />
          <input
            placeholder="Votre numéro de téléphone"
            className="border-2 px-4 rounded-lg text-sm py-2 p-1 w-2/5"
          />
      ...
      <div className="w-full  flex justify-start align-bottom items-end relative">
        ...
        <Image
          src="/image/djamo_app_in_phone_sn.svg"
          width={0}
          height={0}
